...
// Automatically create database and seed data on startup (Zero-friction)
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        {
            adminUser.PasswordHash = "d37e29b473701d83f8e9f00c37d22d387cce56d37671609ee5a6b643a8a8609a"; 
            context.SaveChanges();
